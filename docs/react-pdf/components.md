...
Anchor tag to enable generate and download PDF documents on the fly. Refer to [on the fly rendering](https://react-pdf.org/advanced#on-the-fly-rendering) for more information.
...
Easy and declarative way of getting document's blob data without showing it on screen. Refer to [on the fly rendering](https://react-pdf.org/advanced#on-the-fly-rendering) for more information.
